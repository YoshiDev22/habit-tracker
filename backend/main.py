...
from backend.routers import auth, habits, projects, tasks, pomodoro, boards, project_statuses
...
app.include_router(project_statuses.router, prefix="/api/project-statuses")
